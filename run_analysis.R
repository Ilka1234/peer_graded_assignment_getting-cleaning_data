##First of all install package install.packages("reshape") and install.packages("reshape2")##
##Then library("reshape") and library("reshape2")

#Load files

X_test <- read.table("C:/Users/15476/Desktop/UCI HAR Dataset/test/X_test.txt", quote="\"", comment.char="")

X_train <- read.table("C:/Users/15476/Desktop/UCI HAR Dataset/train/X_train.txt", quote="\"", comment.char="")
